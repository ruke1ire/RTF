...
from src.models.sequence.kernels.spacetime.base import SSM
...
class CompanionSSM(SSM):
    ...
    def __init__(self, norm_order, **kwargs):
        ...
        print(f'CompanionSSM kwargs:{kwargs}')
        super().__init__(**kwargs)

        # Additional vars used for compatibility with s4block format
    ...
    def init_kernel_weights(self, kernel_init):
        print(self.n_kernels, self.kernel_dim)
...
if __name__ == "__main__":
    ...
    comp = CompanionSSM(norm_order=64, model_dim=1, n_kernels=1, kernel_dim=1, kernel_repeat=1)
    print(f'comp:{comp}')